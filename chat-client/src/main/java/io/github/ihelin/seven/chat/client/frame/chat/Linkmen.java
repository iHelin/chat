package io.github.ihelin.seven.chat.client.frame.chat;

import io.github.ihelin.seven.chat.client.frame.TipFrame;
import io.github.ihelin.seven.chat.client.frame.operation.alterColumn.ChangeNickname;
import io.github.ihelin.seven.chat.client.frame.operation.alterColumn.ChangePassword;
import io.github.ihelin.seven.chat.client.frame.operation.alterColumn.ChangeSignature;
import io.github.ihelin.seven.chat.client.frame.operation.friendHandle.AddFriend;
import io.github.ihelin.seven.chat.client.frame.operation.friendHandle.DelFriend;
import io.github.ihelin.seven.chat.client.project.services.SendServers;
...
public class Linkmen extends JFrame {
    ...
    public void init() {
        ...
        panel_3.setLocation(0, 727);
        panel_3.setSize(new Dimension(295, 55));
        panel_3.setOpaque(false);

        //设置头像标签
        label_2 = new JLabel(new ImageIcon(classLoader.getResource("imageSource/4.png").getFile()));
        ...
        icon_1 = new ImageIcon(classLoader.getResource("imageSource/3.png").getFile());
        frame.setIconImage(icon_1.getImage());
        icon = new ImageIcon(classLoader.getResource("imageSource/5.png").getFile());
